...
public partial class MainPage : Page
{
                        ...
                        (
                            ...
                            new AutoLayout()
                                ...
                                (
                                    new TextBox()
                                        ...
                                        .Text(b => b.Bind(() => vm.SearchTerm).TwoWay())
                                        .Height(40)
                            ...
                            new FeedView()
                                ...
                                .ValueTemplate<FeedViewState>(feedViewState =>
                                    new ListView()
                                        .Background(Theme.Brushes.Background.Default)
                                        .ItemsSource(b => b.Bind(() => feedViewState.Data))
                                        .Padding(12, 8)
    ...
    private static UIElement VideoItemTemplate(YouTubeVideo video) => new CardContentControl()
            .Margin(0, 0, 0, 8)
                        ...
                        new AutoLayout()
                            ...
                            (
                                new Border()
                                    ...
                                    (
                                        new Image()
                                            .Source(() => video.Details.Snippet?.Thumbnails?.Medium?.Url!)
                                            .Stretch(Stretch.UniformToFill)
                                    ),
                                new AutoLayout()
                                    .Spacing(8)
                                    ...
                                    (
                                        new Border()
                                            ...
                                            (
                                                new Image()
                                                    .Source(() => video.Channel.Snippet?.Thumbnails?.Medium?.Url!)
                                                    .Stretch(Stretch.UniformToFill)
                                            ),
                                        new AutoLayout()
                                            .PrimaryAxisAlignment(AutoLayoutAlignment.Center)
    ...
    private static UIElement NoneTemplate() => new AutoLayout().Spacing(24)
        .PrimaryAxisAlignment(AutoLayoutAlignment.Center)
        .Padding(0, 0, 0, 122)
        .AutoLayout
        (
    ...
    private static UIElement ErrorTemplate() => new AutoLayout()
        .Spacing(8)
        .PrimaryAxisAlignment(AutoLayoutAlignment.Center)
        .AutoLayout(primaryAlignment: AutoLayoutPrimaryAlignment.Stretch)
        .Children
